                ...
                <ul>
                    ...
                    if($arr[0]!==null){
                        for($i=0;$i<count($arr);$i++){
                            echo "<li>";
                            echo "<a class=\"text-dark\" style=\"text-decoration: none;\" href=\"recipe.php?id=".$arr[$i]["id"]."\">";
                            echo "<img src=\"".$arr[$i]["picture"]."\" alt=\"Nema\" style=\"width: 100px\"> &nbsp;&nbsp;&nbsp;Napitak: <b>".$arr[$i]["name"]."</b> &nbsp;&nbsp;&nbsp;Količina: ".$arr[$i]["quantity"]." bočica";
                            if(isset($_SESSION["admin"]) && $_SESSION["admin"]==1){
                        ...
                        echo "<li>U bazi nema napitaka.</li>";
                    }
                    ?>
                    <hr>
                </ul>
