    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-success bg-success">
            ...
            <div style="background-color: white; width: 100%; min-height: 86%" class="text-center">
                ...
                <?php
                echo "<div class=\"mt-3\">";
                    echo "<h3>".$ing["name"]."</h3><br>";
                    echo "<img src=\"".$ing["picture"]."\" alt=\"Nema\" width=\"200px\">";
                    echo "<form action=\"edit_ingredient.php\" method=\"post\"><br>";
                    echo "<label for=\"quantityInput\">Količina:</label><br>";
                    echo "<input type=\"number\" name=\"quantity\" id=\"quantityInput\" value=\"".$ing["quantity"]."\">g";
                    echo "<input type=\"hidden\" name=\"ret\" value=\"".$ret."\">";
                    echo "<input type=\"hidden\" name=\"ing_id\" value=\"".$ing["id"]."\"><br><br>";
                    echo "<button class=\"btn btn-outline-success\"><i class=\"fa fa-save\"></i> Sačuvaj</button>";
                    echo "</form><hr>";
                    if($ret===null){
                        echo "<a class=\"btn btn-outline-danger\" href=\"ingredients.php\"><i class=\"fa fa-close\"></i> Zatvori</a>";
                    }else{
                        echo "<a class=\"btn btn-outline-danger\" href=\"recipe.php?id=".$ret."\"><i class=\"fa fa-close\"></i> Zatvori</a>";
                    }
                echo "</div>";
                ?>
                <br><br>
