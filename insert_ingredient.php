...
unset($_SESSION["insertI"]);

?>

<html>
    <head>
        <title>Unos sastojka</title>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-success bg-success">
            ...
            <div style="background-color: white; width: 100%; min-height: 86%">
                <br>
                <h3 class="ml-5">Unos sastojka:</h3>
                <?php if($insert!==null){
                    echo "<div><span class=\"ml-5 bg-white text-success mt-3\">".$insert."</span></div>";
                } ?>
                <form method="post" action="insert_i.php" enctype="multipart/form-data"> 
                    ...
                    <div class="col-12 ml-5 mr-n5">
                        <label for="numberInput" class="mt-3">Broj grama:</label> <br>
                        <input class="bg-secondary text-success" type="number" name="number" id="numberInput" <?php if($oldNumber!==null){echo "value=\"".$oldNumber."\"";} ?>>g
